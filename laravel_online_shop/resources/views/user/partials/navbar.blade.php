    ...
    <div class="flex flex-1 justify-end gap-6 items-center">
        ...
        <form class="flex flex-col min-w-40 !h-10 max-w-sm flex-1" action="{{ route('user.products.index') }}"
            ...
            <div class="flex w-full flex-1 items-stretch rounded-lg h-full">
                <div
                    class="text-[#617c89] flex border-none bg-[#f0f3f4] dark:bg-gray-800 items-center justify-center pl-4 rounded-l-lg">
        ...
        <a href="{{ route('user.wishlist.index') }}"
          ...
          {{ $isWishlistPage ? 'bg-red-50 text-red-600' : 'hover:bg-gray-100 text-gray-700' }}">
        ...
        <div class="flex gap-2">
            ...
            @auth
                <a href="{{ url('/profile') }}"
                    class="p-2 hover:bg-[#f0f3f4] dark:hover:bg-gray-800 rounded-lg transition-colors" title="Profile">
